...
set IMAGE_PATH=D:\BaiduNetdiskDownload\project\tableware_detection\image_samples\2\1 (1).jpg

set IMAGE_FOLDER_PATH=D:\BaiduNetdiskDownload\project\tableware_detection\image_samples\2
echo ===============================================
echo        餐具检测程序测试脚本
echo ===============================================
echo.
